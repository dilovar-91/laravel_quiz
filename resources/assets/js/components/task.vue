...
<script>
    export default {
        ...
        methods: {
            ...
            createTask()
            {
                axios.post('http://localhost/laravel_quiz/public/task', {
                    name: this.task.name,
            ...
            readTasks()
            {
                axios.get('http://localhost/laravel_quiz/public/task')
                    .then(response => {
            ...
            updateTask()
            {
                axios.patch('http://localhost/laravel_quiz/public/task/' + this.update_task.id, {
               ...
               deleteTask(index)
            {
                ...
                if (conf === true) {
                    ...
                    axios.delete('http://localhost/laravel_quiz/public/task/' + this.tasks[index].id)
                        .then(response => {
